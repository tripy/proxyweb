...
mysql -uradmin -pradmin -h127.0.0.1 -P6032 -e "INSERT INTO mysql_query_rules (rule_id,activeatch_digest,destination_hostgroup,apply) VALUES (1,1,'^SELECT.*FOR UPDATE',1,1)"
mysql -uradmin -pradmin -h127.0.0.1 -P6032 -e "INSERT INTO mysql_query_rules (rule_id,activeatch_digest,destination_hostgroup,apply) VALUES (2,1,'^SELECT',2,1)"
